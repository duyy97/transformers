...
REGNET_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "facebook/regnet-y-040": "https://hf-mirror.com/facebook/regnet-y-040/blob/main/config.json",
}
...
class RegNetConfig(PretrainedConfig):
    ...
    [facebook/regnet-y-040](https://hf-mirror.com/facebook/regnet-y-040) architecture.
