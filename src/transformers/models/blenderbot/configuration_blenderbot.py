...
BLENDERBOT_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "facebook/blenderbot-3B": "https://hf-mirror.com/facebook/blenderbot-3B/resolve/main/config.json",
...
class BlenderbotConfig(PretrainedConfig):
    ...
    [facebook/blenderbot-3B](https://hf-mirror.com/facebook/blenderbot-3B) architecture.
