...
VAN_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "Visual-Attention-Network/van-base": (
        "https://hf-mirror.com/Visual-Attention-Network/van-base/blob/main/config.json"
    ),
}
...
class VanConfig(PretrainedConfig):
    ...
    [Visual-Attention-Network/van-base](https://hf-mirror.com/Visual-Attention-Network/van-base) architecture.
