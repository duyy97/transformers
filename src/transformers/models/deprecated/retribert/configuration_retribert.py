...
RETRIBERT_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "yjernite/retribert-base-uncased": (
        "https://hf-mirror.com/yjernite/retribert-base-uncased/resolve/main/config.json"
    ),
}
...
class RetriBertConfig(PretrainedConfig):
    ...
    [yjernite/retribert-base-uncased](https://hf-mirror.com/yjernite/retribert-base-uncased) architecture.
