...
TRANSFO_XL_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "transfo-xl/transfo-xl-wt103": "https://hf-mirror.com/transfo-xl/transfo-xl-wt103/resolve/main/config.json",
}
...
class TransfoXLConfig(PretrainedConfig):
    ...
    [transfo-xl/transfo-xl-wt103](https://hf-mirror.com/transfo-xl/transfo-xl-wt103) architecture.
