...
MCTCT_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "speechbrain/m-ctc-t-large": "https://hf-mirror.com/speechbrain/m-ctc-t-large/resolve/main/config.json",
...
class MCTCTConfig(PretrainedConfig):
    ...
    [speechbrain/m-ctc-t-large](https://hf-mirror.com/speechbrain/m-ctc-t-large) architecture.
