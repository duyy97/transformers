...
SWIFTFORMER_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "MBZUAI/swiftformer-xs": "https://hf-mirror.com/MBZUAI/swiftformer-xs/resolve/main/config.json",
}
...
class SwiftFormerConfig(PretrainedConfig):
    ...
    [MBZUAI/swiftformer-xs](https://hf-mirror.com/MBZUAI/swiftformer-xs) architecture.
