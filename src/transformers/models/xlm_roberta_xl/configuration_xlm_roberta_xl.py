...
XLM_ROBERTA_XL_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "facebook/xlm-roberta-xl": "https://hf-mirror.com/facebook/xlm-roberta-xl/resolve/main/config.json",
    "facebook/xlm-roberta-xxl": "https://hf-mirror.com/facebook/xlm-roberta-xxl/resolve/main/config.json",
    # See all XLM-RoBERTa-XL models at https://hf-mirror.com/models?filter=xlm-roberta-xl
}
...
class XLMRobertaXLConfig(PretrainedConfig):
    ...
    XLM_ROBERTA_XL [facebook/xlm-roberta-xl](https://hf-mirror.com/facebook/xlm-roberta-xl) architecture.
