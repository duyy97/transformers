...
MOBILEVIT_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "apple/mobilevit-small": "https://hf-mirror.com/apple/mobilevit-small/resolve/main/config.json",
    "apple/mobilevit-x-small": "https://hf-mirror.com/apple/mobilevit-x-small/resolve/main/config.json",
    "apple/mobilevit-xx-small": "https://hf-mirror.com/apple/mobilevit-xx-small/resolve/main/config.json",
    "apple/deeplabv3-mobilevit-small": (
        "https://hf-mirror.com/apple/deeplabv3-mobilevit-small/resolve/main/config.json"
    ),
    "apple/deeplabv3-mobilevit-x-small": (
        "https://hf-mirror.com/apple/deeplabv3-mobilevit-x-small/resolve/main/config.json"
    ),
    "apple/deeplabv3-mobilevit-xx-small": (
        "https://hf-mirror.com/apple/deeplabv3-mobilevit-xx-small/resolve/main/config.json"
    ),
...
class MobileViTConfig(PretrainedConfig):
    ...
    [apple/mobilevit-small](https://hf-mirror.com/apple/mobilevit-small) architecture.
