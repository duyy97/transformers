...
def main():
    ...
    parser.add_argument(
        ...
        help="'f' models correspond to the finetuned versions, and are specific to the Llama2 official release. For more details on Llama2, checkout the original repo: https://hf-mirror.com/meta-llama",
    )
    parser.add_argument(
        "--output_dir",
