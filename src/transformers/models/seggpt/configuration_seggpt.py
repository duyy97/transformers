...
SEGGPT_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "BAAI/seggpt-vit-large": "https://hf-mirror.com/BAAI/seggpt-vit-large/resolve/main/config.json",
}
...
class SegGptConfig(PretrainedConfig):
    ...
    [BAAI/seggpt-vit-large](https://hf-mirror.com/BAAI/seggpt-vit-large) architecture.
