...
PERSIMMON_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "adept/persimmon-8b-base": "https://hf-mirror.com/adept/persimmon-8b-base/resolve/main/config.json",
}
...
class PersimmonConfig(PretrainedConfig):
    ...
    [adept/persimmon-8b-base](https://hf-mirror.com/adept/persimmon-8b-base).
