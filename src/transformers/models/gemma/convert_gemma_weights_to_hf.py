...
def main():
    ...
    parser.add_argument(
        ...
        help="'f' models correspond to the finetuned versions, and are specific to the Gemma2 official release. For more details on Gemma2, checkout the original repo: https://hf-mirror.com/google/gemma-7b",
    )
    parser.add_argument(
        "--output_dir",
