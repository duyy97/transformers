...
OPENAI_GPT_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "openai-community/openai-gpt": "https://hf-mirror.com/openai-community/openai-gpt/resolve/main/config.json"
}
...
class OpenAIGPTConfig(PretrainedConfig):
    ...
    [openai-community/openai-gpt](https://hf-mirror.com/openai-community/openai-gpt) architecture from OpenAI.
