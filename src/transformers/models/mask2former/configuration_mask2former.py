...
MASK2FORMER_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "facebook/mask2former-swin-small-coco-instance": (
        "https://hf-mirror.com/facebook/mask2former-swin-small-coco-instance/blob/main/config.json"
    )
...
class Mask2FormerConfig(PretrainedConfig):
    ...
    [facebook/mask2former-swin-small-coco-instance](https://hf-mirror.com/facebook/mask2former-swin-small-coco-instance)
    architecture.
