...
MGP_STR_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "alibaba-damo/mgp-str-base": "https://hf-mirror.com/alibaba-damo/mgp-str-base/resolve/main/config.json",
}
...
class MgpstrConfig(PretrainedConfig):
    ...
    [alibaba-damo/mgp-str-base](https://hf-mirror.com/alibaba-damo/mgp-str-base) architecture.
