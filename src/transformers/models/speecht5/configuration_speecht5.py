...
SPEECHT5_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "microsoft/speecht5_asr": "https://hf-mirror.com/microsoft/speecht5_asr/resolve/main/config.json",
    "microsoft/speecht5_tts": "https://hf-mirror.com/microsoft/speecht5_tts/resolve/main/config.json",
    "microsoft/speecht5_vc": "https://hf-mirror.com/microsoft/speecht5_vc/resolve/main/config.json",
}
...
class SpeechT5Config(PretrainedConfig):
    ...
    [microsoft/speecht5_asr](https://hf-mirror.com/microsoft/speecht5_asr) architecture.
...
class SpeechT5HifiGanConfig(PretrainedConfig):
    ...
    [microsoft/speecht5_hifigan](https://hf-mirror.com/microsoft/speecht5_hifigan) architecture.
