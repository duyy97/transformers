...
class CopyCheckTester(unittest.TestCase):
    ...
    def test_convert_to_localized_md(self):
        ...
        md_list = (
            "1. **[ALBERT](https://hf-mirror.com/transformers/model_doc/albert.html)** (from Google Research and the"
            " Toyota Technological Institute at Chicago) released with the paper [ALBERT: A Lite BERT for"
            " Self-supervised Learning of Language Representations](https://arxiv.org/abs/1909.11942), by Zhenzhong"
            " Lan, Mingda Chen, Sebastian Goodman, Kevin Gimpel, Piyush Sharma, Radu Soricut.\n1."
            " **[DistilBERT](https://hf-mirror.com/transformers/model_doc/distilbert.html)** (from HuggingFace),"
            ...
            " version of DistilBERT.\n1. **[ELECTRA](https://hf-mirror.com/transformers/model_doc/electra.html)**"
            " (from Google Research/Stanford University) released with the paper [ELECTRA: Pre-training text encoders"
            " as discriminators rather than generators](https://arxiv.org/abs/2003.10555) by Kevin Clark, Minh-Thang"
            " Luong, Quoc V. Le, Christopher D. Manning."
        )
        localized_md_list = (
            "1. **[ALBERT](https://hf-mirror.com/transformers/model_doc/albert.html)** (来自 Google Research and the"
        ...
        converted_md_list_sample = (
            ...
            " Language Representations](https://arxiv.org/abs/1909.11942), 由 Zhenzhong Lan, Mingda Chen, Sebastian"
            " Goodman, Kevin Gimpel, Piyush Sharma, Radu Soricut 发布。\n1."
            " **[DistilBERT](https://hf-mirror.com/transformers/model_doc/distilbert.html)** (来自 HuggingFace) 伴随论文"
            ...
            " Multilingual BERT into"
            " [DistilmBERT](https://github.com/huggingface/transformers/tree/main/examples/distillation) and a German"
            " version of DistilBERT.\n1. **[ELECTRA](https://hf-mirror.com/transformers/model_doc/electra.html)** (来自"
        ...
        link_unchanged_md_list = (
            "1. **[ALBERT](https://hf-mirror.com/transformers/main/model_doc/albert.html)** (来自 Google Research and"
