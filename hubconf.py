...
def config(*args, **kwargs):
    r"""
                ...
                config = torch.hub.load('huggingface/transformers', 'config', 'google-bert/bert-base-uncased')  # Download configuration from hf-mirror.com and cache.
...
def tokenizer(*args, **kwargs):
    r"""
        ...
        tokenizer = torch.hub.load('huggingface/transformers', 'tokenizer', 'google-bert/bert-base-uncased')    # Download vocabulary from hf-mirror.com and cache.
...
def model(*args, **kwargs):
    r"""
            ...
            model = torch.hub.load('huggingface/transformers', 'model', 'google-bert/bert-base-uncased')    # Download model and configuration from hf-mirror.com and cache.
...
def modelForCausalLM(*args, **kwargs):
    r"""
        ...
        model = torch.hub.load('huggingface/transformers', 'modelForCausalLM', 'openai-community/gpt2')    # Download model and configuration from hf-mirror.com and cache.
...
def modelForMaskedLM(*args, **kwargs):
    r"""
            ...
            model = torch.hub.load('huggingface/transformers', 'modelForMaskedLM', 'google-bert/bert-base-uncased')    # Download model and configuration from hf-mirror.com and cache.
...
def modelForSequenceClassification(*args, **kwargs):
    r"""
            ...
            model = torch.hub.load('huggingface/transformers', 'modelForSequenceClassification', 'google-bert/bert-base-uncased')    # Download model and configuration from hf-mirror.com and cache.
...
def modelForQuestionAnswering(*args, **kwargs):
    r"""
        ...
        model = torch.hub.load('huggingface/transformers', 'modelForQuestionAnswering', 'google-bert/bert-base-uncased')    # Download model and configuration from hf-mirror.com and cache.
