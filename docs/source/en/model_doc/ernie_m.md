...
This model was contributed by [Susnato Dhar](https://hf-mirror.com/susnato). The original code can be found [here](https://github.com/PaddlePaddle/PaddleNLP/tree/develop/paddlenlp/transformers/ernie_m).
