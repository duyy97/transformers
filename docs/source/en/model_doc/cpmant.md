...
This model was contributed by [OpenBMB](https://hf-mirror.com/openbmb). The original code can be found [here](https://github.com/OpenBMB/CPM-Live/tree/cpm-ant/cpm-live).
