...
This model was contributed by [Alara Dirik](https://hf-mirror.com/adirik).
...
- A blog post on [ALIGN and the COYO-700M dataset](https://hf-mirror.com/blog/vit-align).
- A zero-shot image classification [demo](https://hf-mirror.com/spaces/adirik/ALIGN-zero-shot-image-classification).
- [Model card](https://hf-mirror.com/kakaobrain/align-base) of `kakaobrain/align-base` model.
