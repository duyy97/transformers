...
This model was contributed by [matthijs](https://hf-mirror.com/Matthijs). The TensorFlow version of the model was contributed by [sayakpaul](https://hf-mirror.com/sayakpaul). The original code and weights can be found [here](https://github.com/apple/ml-cvnets).
