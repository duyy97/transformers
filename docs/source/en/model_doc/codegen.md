...
This model was contributed by [Hiroaki Hayashi](https://hf-mirror.com/rooa).
The original code can be found [here](https://github.com/salesforce/codegen).

## Checkpoint Naming

* CodeGen model [checkpoints](https://hf-mirror.com/models?other=codegen) are available on different pre-training data with variable sizes.
