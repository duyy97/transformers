...
This model was contributed by [CarlCochet](https://hf-mirror.com/CarlCochet). The original code can be found [here](https://github.com/jannerm/trajectory-transformer).
