...
1. Finetune [T5](https://hf-mirror.com/google-t5/t5-small) on the English-French subset of the [OPUS Books](https://hf-mirror.com/datasets/opus_books) dataset to translate English text to French.
...
Start by loading the English-French subset of the [OPUS Books](https://hf-mirror.com/datasets/opus_books) dataset from the 🤗 Datasets library:
...
Including a metric during training is often helpful for evaluating your model's performance. You can quickly load a evaluation method with the 🤗 [Evaluate](https://hf-mirror.com/docs/evaluate/index) library. For this task, load the [SacreBLEU](https://hf-mirror.com/spaces/evaluate-metric/sacrebleu) metric (see the 🤗 Evaluate [quick tour](https://hf-mirror.com/docs/evaluate/a_quick_tour) to learn more about how to load and compute a metric):
